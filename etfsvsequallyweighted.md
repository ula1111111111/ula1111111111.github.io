...
<div class="logo-carousel-section">
  <div class="logo-carousel-container">
    <div class="logo-carousel-track">
      <div class="logo-item">
        <div class="logo-text">NASDAQ</div>
      </div>
      <div class="logo-item">
        <div class="logo-text">BlackRock</div>
      </div>
      <div class="logo-item">
        <div class="logo-text">Microsoft</div>
      </div>
      <div class="logo-item">
        <div class="logo-text">Apple</div>
      </div>
      <div class="logo-item">
        <div class="logo-text">Fidelity</div>
      </div>
      <div class="logo-item">
        <div class="logo-text">Vanguard</div>
      </div>
      <div class="logo-item">
        <div class="logo-text">Goldman Sachs</div>
      </div>
      <div class="logo-item">
        <div class="logo-text">JPMorgan</div>
      </div>
      <div class="logo-item">
        <div class="logo-text">Amazon</div>
      </div>
      <div class="logo-item">
        <div class="logo-text">Google</div>
      </div>
